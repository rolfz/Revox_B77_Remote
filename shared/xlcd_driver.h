/*
   Original microchip header file with PICSTAR modifications.
   Modified by: Rolf Ziegler
x
 */
#ifndef __XLCD_H
#define __XLCD_H
 ...
 */
 #define RS_PIN   PORTCbits.RC0         /* PORT for RS */
 #define RW_PIN   PORTCbits.RC1         /* PORT for RW */
 #define E_PIN    PORTCbits.RC2         /* PORT for D  */

 #define TRIS_RS  DDRCbits.RC0       /* TRIS for RS */
 #define TRIS_RW  DDRCbits.RC1       /* TRIS for RW */
 #define TRIS_E   DDRCbits.RC2       /* TRIS for E  */

// added bay z-control
 #define TRIS_LCD_BACKLIGHT     TRISAbits.TRISA3
 #define LCD_BACKLIGHT 		LATAbits.LATA3
