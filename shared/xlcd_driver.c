/*
	Copie du code Microchip XLCD, comtient une version corrigée et complétée de xlcd.h
	Fonctions standard pour l'utilisation avec le circuit LCD de Z-CONTROL.

	Fonctions supplémentaire
	void set_backlight(unsigned char set); set= 0 lcd backlight off, set=1 backlight on	
	void lcd_init(void); initialise Z-Display
	void lcd_delete(void); efface les 2 lignes de l'écran
	void lcd_gotoxy(unsigned char x, unsigned char y); position du curseur pour l'écriture, 
									x=0,y=0 pour la première position de la première ligne.
...
//#include "..\src\pmc_common\XLCD\openxlcd.c"
/********************************************************************
...
//#include "..\src\pmc_common\XLCD\putrxlcd.c"
/********************************************************************
...
//#include "..\src\pmc_common\XLCD\readaddr.c"
/*********************************************************************
...
//#include "..\src\pmc_common\XLCD\readdata.c"
...
//#include "..\src\pmc_common\XLCD\setcgram.c"
/********************************************************************
...
//#include "..\src\pmc_common\XLCD\setddram.c"
...
//#include "..\src\pmc_common\XLCD\wcmdxlcd.c"
...
//#include "..\src\pmc_common\XLCD\writdata.c"
...
void set_backlight(unsigned char set)
{
	LCD_BACKLIGHT=set;
}
